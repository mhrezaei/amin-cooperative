...
<div class="auth-wrapper">
    ...
    <div class="auth-col">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
            {{ csrf_field() }}
            <div class="field"><input type="text" name="mobile" id="mobile"
                                      placeholder="{{ trans('validation.attributes.mobile') }}" required autofocus>
            </div>
            ...
            <hr class="or">
            <div class="tal">
                <button type="button" onclick="window.location = '{{ url('/password/reset') }}';"
                        class="blue block"> {{ trans('people.form.recover_password') }} </button>
            </div>
